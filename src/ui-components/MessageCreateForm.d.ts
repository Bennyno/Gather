...
export declare type MessageCreateFormValidationValues = {
    ...
    messageTime?: ValidationFunction<string>;
    messageDate?: ValidationFunction<string>;
};
...
export declare type MessageCreateFormOverridesProps = {
    ...
    messageTime?: PrimitiveOverrideProps<TextFieldProps>;
    messageDate?: PrimitiveOverrideProps<TextFieldProps>;
} & EscapeHatchProps;
